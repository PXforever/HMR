...
void SetPWMFreq(float freq) {
	...
	for(int sleep=0;sleep<4000;sleep++);
...
//	printf("setPWM");
	...
	unsigned char stop[5]={0};
	on_off[0] = on;
	on_off[1] = on>>8;
	on_off[2] = off;
	on_off[3] = off>>8;
	HAL_I2C_Mem_Write(&hi2c1,_i2caddr,LED0_ON_L+4*num,I2C_MEMADD_SIZE_8BIT,on_off,4,35);
	HAL_I2C_Mem_Write(&hi2c1,_i2caddr,LED0_ON_L+4*num,I2C_MEMADD_SIZE_8BIT,stop,4,35);//
...
/*调试代码*/
//	HAL_StatusTypeDef states;
//	
//	states = HAL_I2C_Mem_Write(&hi2c1,_i2caddr,addr,I2C_MEMADD_SIZE_8BIT,&d,1,35);
//	if(states!= HAL_OK)
//	{
//		printf("Transmit Eorr:%d",states);
//	}
//	else 
//	{
